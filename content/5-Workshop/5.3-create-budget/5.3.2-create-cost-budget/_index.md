...
Follow these steps to set up your cost threshold configurations[cite: 1]:

1. Click on the **Create budget** button[cite: 1].
2. If prompted by AWS to select a budget setup type, choose **Use a template (simplified)**[cite: 1].
3. Under the **Templates - new** section, select the **Monthly cost budget** template[cite: 1].
4. Proceed to configure the detailed budget parameters as follows[cite: 1]:
