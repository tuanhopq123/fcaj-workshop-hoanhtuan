...
Thực hiện các bước sau để thiết lập cấu hình hạn mức chi phí[cite: 1]:

1. Bấm vào nút **Create budget**[cite: 1].
2. Nếu AWS hỏi chọn loại budget, tích chọn **Use a template (simplified)**[cite: 1].
3. Tại phần **Templates - new**, chọn mẫu **Monthly cost budget**[cite: 1].
4. Tiến hành cấu hình các thông số chi tiết của Budget như sau[cite: 1]:
