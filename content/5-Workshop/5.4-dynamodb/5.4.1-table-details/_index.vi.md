...
![Cấu hình Table details](dynamodb-table-details.png)
...
![Cấu hình Chế độ On-demand](dynamodb-on-demand-settings.png)
...
![Bảng DynamoDB ở trạng thái Active](dynamodb-table-active.png)